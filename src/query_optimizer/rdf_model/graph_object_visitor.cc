...
ObjectId GraphObjectVisitor::operator()(const GraphObject& obj) const {
    switch (obj.type) {
        ...
        case GraphObjectType::IRI_INLINED: {
            ...
            return ObjectId(res | ObjectId::INLINE_IRI_MASK | shifted_prefix_id);
        }
        case GraphObjectType::IRI_TMP: {
            if (create_if_not_exists) {
                ...
                if (external_id == ObjectId::OBJECT_ID_NOT_FOUND) {
                    ...
                    return ObjectId(external_id | ObjectId::EXTERNAL_IRI_MASK | shifted_prefix_id);
                }
            }
        }
        case GraphObjectType::LITERAL_DATATYPE_INLINED: {
            ...
            return ObjectId(res | ObjectId::VALUE_INLINE_STR_DATATYPE_MASK | shifted_datatype_id);
        }
        case GraphObjectType::LITERAL_DATATYPE_TMP: {
            if (create_if_not_exists) {
                ...
                if (external_id == ObjectId::OBJECT_ID_NOT_FOUND) {
                    ...
                    return ObjectId(external_id | ObjectId::VALUE_EXTERNAL_STR_DATATYPE_MASK | shifted_datatype_id);
                }
            }
        }
        case GraphObjectType::LITERAL_LANGUAGE_INLINED: {
            ...
            return ObjectId(res | ObjectId::VALUE_INLINE_STR_LANGUAGE_MASK | shifted_language_id);
        }
        case GraphObjectType::LITERAL_LANGUAGE_TMP: {
            if (create_if_not_exists) {
                ...
                if (external_id == ObjectId::OBJECT_ID_NOT_FOUND) {
                    ...
                    return ObjectId(external_id | ObjectId::VALUE_EXTERNAL_STR_LANGUAGE_MASK | shifted_language_id);
                }
            }
        }
        case GraphObjectType::DATETIME: {
            return ObjectId(obj.value.datetime.id | ObjectId::VALUE_DATETIME_MASK);
        }
        case GraphObjectType::DECIMAL: {
            return ObjectId(obj.value.decimal.id | ObjectId::VALUE_DECIMAL_MASK);
        }
