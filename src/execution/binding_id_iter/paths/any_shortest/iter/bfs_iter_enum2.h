...
/*
BFSIterEnum enumerates paths from or to a specific node, using BFS algorithm.
...
to keep a B+Tree Iter as class member to be able to resume the search after
next returned.
*/
class BFSIterEnum2 : public BindingIdIter {
private:
