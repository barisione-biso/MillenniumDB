 ...
 * encoded). Currently, only strings are supported.
 * All strings are meant to be encoded in UTF-8.
 *
 ...
 *
 * Because the ID=0 is special (represents a nonexistent object), we need to write a trash byte when creating the
