#ifndef RELATIONAL_MODEL__MERGE_PLAN_H_
#define RELATIONAL_MODEL__MERGE_PLAN_H_

#include "base/graph/graph_object.h"
#include "base/ids/graph_id.h"
#include "relational_model/query_optimizer/join_plan/join_plan.h"

class MergePlan : public JoinPlan {
public:
    MergePlan(const MergePlan& other);
    MergePlan(std::unique_ptr<JoinPlan> lhs, std::unique_ptr<JoinPlan> rhs);
    ~MergePlan() = default;
...
#endif // RELATIONAL_MODEL__MERGE_PLAN_H_
