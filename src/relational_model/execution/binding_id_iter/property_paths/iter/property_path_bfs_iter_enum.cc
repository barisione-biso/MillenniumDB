...
bool PropertyPathBFSIterEnum::current_state_has_next(const StateKey&  current_state) {
...
void PropertyPathBFSIterEnum::set_iter(const StateKey& current_state) {
