#include "property_path_dfs_check.h"
...
PropertyPathDFSCheck::PropertyPathDFSCheck(BPlusTree<4>& type_from_to_edge,
...
void PropertyPathDFSCheck::begin(BindingId& parent_binding, bool parent_has_next) {
...
void PropertyPathDFSCheck::reset() {
...
void PropertyPathDFSCheck::assign_nulls() { }


void PropertyPathDFSCheck::analyze(int indent) const {
    for (int i = 0; i < indent; ++i) {
        cout << ' ';
    }
    cout << "PropertyPathDFSCheck(bpt_searches: " << bpt_searches
         << ", found: " << results_found <<")\n";
}
