...
namespace manual_plan {
    namespace parser {
        ...
        auto const node_label_def =
            lexeme["NodeLabel"] >> "(" >> var >> "," >> common::parser::string >> ")";

        auto const edge_label_def =
            lexeme["EdgeLabel"] >> "(" >> var >> "," >> common::parser::string >> ")";

        auto const node_property_def =
            lexeme["NodeProperty"] >> "(" >> var >> "," >> common::parser::string >> "," >> value >> ")";

        auto const edge_property_def =
            lexeme["EdgeProperty"] >> "(" >> var >> "," >> common::parser::string >> "," >> value >> ")";

        auto const connection_def =
            lexeme["Connection"] >> "(" >> var >> "," >> var >> "," >> var >> ")";

        auto const labeled_connection_def =
            lexeme["LabeledConnection"] >> "(" >> common::parser::string >> "," >> var >> "," >> var >> "," >> var >> ")";
