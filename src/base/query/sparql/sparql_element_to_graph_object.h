...
struct SparqlElementToGraphObject {
    ...
    //     }
    //     if (str.size() < 7) {
    //         return GraphObjectFactory::make_iri_inlined(str.c_str(), prefix_id);
    //     } else {
    //         return GraphObjectFactory::make_iri_tmp(iri.name);
    //     }
    // }

    // GraphObject operator()(const Literal& l) {
    //     return GraphObjectFactory::make_string(l.str);
    // }
    ...
    //                 return GraphObjectFactory::make_literal_datatype_inlined(ld.str.c_str(), i);
    //             }
    //         }
    //     }
    //     // Not inlined str or datatype not found
    //     return GraphObjectFactory::make_literal_datatype_tmp(ld);
    // }
    ...
    //                 return GraphObjectFactory::make_literal_language_inlined(ll.str.c_str(), i);
    //             }
    //         }
    //     }
    //     // Not inlined str or language not found
    //     return GraphObjectFactory::make_literal_language_tmp(ll);
    // }

    // GraphObject operator()(const DateTime& dt) {
    //     return GraphObjectFactory::make_datetime(dt.id);
    // }

    // GraphObject operator()(const Decimal& d) {
    //     return GraphObjectFactory::make_decimal(d.id);
    // }

    // GraphObject operator()(const Boolean& b) {
    //     return GraphObjectFactory::make_boolean(b.id);
    // }

    // GraphObject operator()(const std::unique_ptr<SPARQL::IPath>& /*p*/) {
    //     // TODO: Implement this
    //     return GraphObjectFactory::make_string("PATH");
    // }
